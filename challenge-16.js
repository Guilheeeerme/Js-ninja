...
*/
    ...
    name.split('').map((item, indice) => {
        console.log(`${item} é a ${indice+1}ª do meu nome.`)
    });
...
*/
    ...
    let fullName = 'guilherme-de-moura-neto';
...
*/
    ...
    const friends = ['Guilherme', 'João', 'Maria', 'Pedro', 'Jéssica'];
    const phrase = friends.reduce((acumulador, atual, index) => {
