...
*/
    ...
    console.log(text.replace(/Manuel Marques de Sousa/,'Guilherme de Moura Neto'));
...
*/
    ...
    console.log(text.replace(/[0-9]/g, '-')); // Usando lista
...
*/
    ...
    console.log(text.replace(/[D-Hd-h]/g, '0')); // Usando lista
...
*/
    ...
    console.log(text.replace(/O Centauro de Luvas/g, (palavra) => {
...
*/
    ...
    let refexDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/g;

    console.log(refexDate);
...
*/
    ...
    const replaceDate = (regex, day, month, year) => {
