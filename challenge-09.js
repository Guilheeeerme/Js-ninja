...
const calculator = (num1,num2) => {
    return (callback) => { // arrow function anônima
...
*/
let subtraction = calculator(10,10);
let multiplication = calculator(10,10);
let division = calculator(10,10);
let mod = calculator(10,10);
...
console.log('O resultado do resto da divisão é:');
console.log(sum((num1,num2) => {
    return num1 % num2;
}));
